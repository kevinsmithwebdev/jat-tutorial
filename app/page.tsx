  ...
  return (
     <div className="flex min-h-screen flex-col bg-white">
        <div className="flex-1">
          <section className="container mx-auto px-4 py-32"> {/* Hero Section */}
            <div className="max-auto max-w-4xl text-center">
              ...
              <div className="flex flex-col items-center gap-4">
                <Link href="/sign-up" className="h-12 text-lg hover:text-white">
                  <Button size="lg">Start for free <ArrowRight className="ml-2" /></Button>
                </Link>
